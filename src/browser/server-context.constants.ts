...
export const MANAGED_BROWSER_IDLE_TAB_TTL_MS = 60_000;
export const MANAGED_BROWSER_PENDING_OPEN_TTL_MS = 10_000;
export const MANAGED_BROWSER_MAX_REBIND_ATTEMPTS = 2;
